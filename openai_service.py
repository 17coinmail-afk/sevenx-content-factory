...
{{
  "variants": [
    {{"text": "текст поста с HTML-тегами <b></b> и пустыми строками между абзацами", "hashtags": "#тег1 #тег2 #тег3", "image_hook": "ДЕНЬГИ ДОШЛИ ЗА ДЕНЬ"}},
    {{"text": "...", "hashtags": "...", "image_hook": "БАНК ОТКАЗАЛ НАМ НЕТ"}},
    {{"text": "...", "hashtags": "...", "image_hook": "ПЛАТЁЖ БЕЗ ГРАНИЦ"}}
  ]
}}

image_hook — максимум 5 слов СТРОГО НА РУССКОМ ЯЗЫКЕ кириллицей, провокационный крючок для картинки (только заглавные буквы, без знаков препинания). Никаких английских слов, никакой транслитерации. Должен заставить остановиться при скролле."""
